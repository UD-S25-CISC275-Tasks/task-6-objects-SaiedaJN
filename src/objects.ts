...
export function isCorrect(question: Question, answer: string): boolean {
    return answer.trim().toLocaleLowerCase() === question.expected.trim().toLocaleLowerCase() ? true: false;
    // return answer.trim().toLocaleLowerCase() === question.expected.trim().toLocaleLowerCase();
}
